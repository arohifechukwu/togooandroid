...
//                    );
//
//                    // ✅ Ensure selectedRestaurant is never null
...
//                }
//
//                featuredItemsAdapter = new FoodAdapter(RestaurantPageActivity.this, featuredItems, selectedRestaurant, foodItem -> {
...
//                    FoodAdapter sectionAdapter = new FoodAdapter(RestaurantPageActivity.this, sectionItems, selectedRestaurant, foodItem -> {
//                        Intent intent = new Intent(RestaurantPageActivity.this, FoodDetailActivity.class);
//                        intent.putExtra("foodId", foodItem.getId());
//                        intent.putExtra("foodDescription", foodItem.getDescription());
//                        intent.putExtra("foodImage", foodItem.getImageURL());
    ...
    private void fetchFeaturedItems() {
        restaurantRef.child("Special Offers").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                featuredItemsAdapter = new FoodAdapter(RestaurantPageActivity.this, featuredItems, RestaurantHelper.getCurrentRestaurant(), foodItem -> {
                    Intent intent = new Intent(RestaurantPageActivity.this, FoodDetailActivity.class);
                    intent.putExtra("foodId", foodItem.getId());
                    intent.putExtra("foodDescription", foodItem.getDescription());
                    intent.putExtra("foodImage", foodItem.getImageURL());
        ...
        restaurantRef.child("menu").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot sectionSnap : snapshot.getChildren()) {
                    ...
                    FoodAdapter sectionAdapter = new FoodAdapter(RestaurantPageActivity.this, sectionItems, RestaurantHelper.getCurrentRestaurant(), foodItem -> {
                        Intent intent = new Intent(RestaurantPageActivity.this, FoodDetailActivity.class);
                        intent.putExtra("foodId", foodItem.getId());
                        intent.putExtra("foodDescription", foodItem.getDescription());
                        intent.putExtra("foodImage", foodItem.getImageURL());
